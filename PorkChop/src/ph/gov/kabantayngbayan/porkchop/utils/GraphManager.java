...
public class GraphManager {
	...
	public GraphicalView getPieChartView(Context context, List<PieChartModel> pies, String title, 
			boolean showZoomButton, boolean zoomEnable, boolean showLegend, boolean isPanEnable, boolean setBackgroundColor) {
		...
		mRenderer.setApplyBackgroundColor(setBackgroundColor);
